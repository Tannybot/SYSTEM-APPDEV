                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $nop=$row["nop"]; // Get the capacity limit
                                         ...
                                         <tr>
                                             <td colspan="4">
                                                 ...
                                                 <center>
                                                     ...
                                                     <br>
                                                     <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Session Full</p>
                                                     <p class="heading-main12" style="margin-left: 45px;font-size:16px;color:rgb(49, 49, 49)">This appointment has reached its maximum capacity of '.$nop.' students and cannot accept more bookings.</p>
                                                     <a class="non-style-link" href="schedule.php"><button class="login-btn btn-primary-soft btn" style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; View Other Sessions &nbsp;</button></a>
                                                 </center>
                                                 <br><br><br><br>
                                             </td>
                                         </tr>';
