...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['remove'])){
        ...
        $sql = "UPDATE student SET profile_image = NULL WHERE sid = ?";
        ...
        if(!in_array($file['type'], $allowed_types)){
            ...
            if($file['size'] > 2 * 1024 * 1024){
                ...
                if(move_uploaded_file($file['tmp_name'], $target_path)){
                    // Update database
                    $sql = "UPDATE student SET profile_image = ? WHERE sid = ?";
                    $stmt = $database->prepare($sql);
...
<body>
                            ...
                            <tr>
                                <td style="padding:0px;margin:0px;">
                                    <div style="display: flex; align-items: center;">
                                        ...
                                        <div>
                                            <p class="profile-title"><?php echo substr($userfetch["sname"],0,13)  ?>..</p>
    ...
    if(isset($error)){
        ...
        <div id="popup1" class="overlay">
                ...
                <br><br><br><br>
                    <h2>Upload Failed!</h2>
                    <a class="close" href="upload-profile-student.php">&times;</a>
                    <div class="content">
                        '.$error.'
                    ...
                    <a href="upload-profile-student.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
