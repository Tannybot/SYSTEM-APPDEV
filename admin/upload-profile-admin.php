...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    if(isset($_POST['remove'])){
        ...
        $sql = "UPDATE admin SET profile_image = NULL WHERE aemail = ?";
    ...
    if($file['error'] !== UPLOAD_ERR_OK){
        ...
        if(!in_array($file['type'], $allowed_types)){
            ...
            if($file['size'] > 2 * 1024 * 1024){
                ...
                $filename = "admin_" . str_replace('@', '_', $userid) . "_" . time() . "." . $ext;
                $target_path = "../img/" . $filename;

                // Move uploaded file
                if(move_uploaded_file($file['tmp_name'], $target_path)){
                    // Update database
                    $sql = "UPDATE admin SET profile_image = ? WHERE aemail = ?";
                    $stmt = $database->prepare($sql);
...
<body>
            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-student">
                        <a href="student.php" class="non-style-link-menu"><div><p class="menu-text">Students</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-session">
                        <a href="schedule.php" class="non-style-link-menu"><div><p class="menu-text">Sessions</p></a></div>
                    </td>
                </tr>
    ...
    if(isset($error)){
        ...
        <div id="popup1" class="overlay">
                ...
                <br><br><br><br>
                    <h2>Upload Failed!</h2>
                    <a class="close" href="upload-profile-admin.php">&times;</a>
                    <div class="content">
                        '.$error.'
                    ...
                    <a href="upload-profile-admin.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
                ...
                <center>
                    ...
                    <tr>
                            <td class="label-td" colspan="2">'.
                                '<form action="upload-profile-admin.php" method="POST" enctype="multipart/form-data">
